...
describe('Order CRUD tests', function () {
          ...
          .end(function (orderSaveErr, orderSaveRes) {
            ...
            agent.get('/api/orders')
              .end(function (ordersGetErr, ordersGetRes) {
                ...
                (orders[0].status).should.match('Order status');
  ...
  it('should not be able to save an Order if no status is provided', function (done) {
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/orders')
          ...
          .end(function (orderSaveErr, orderSaveRes) {
            ...
            (orderSaveRes.body.message).should.match('Please fill Order status');
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/orders')
          ...
          .end(function (orderSaveErr, orderSaveRes) {
            ...
            // Update Order name
            order.status = 'WHY YOU GOTTA BE SO MEAN?';
            ...
            agent.put('/api/orders/' + orderSaveRes.body._id)
              ...
              .end(function (orderUpdateErr, orderUpdateRes) {
                ...
                (orderUpdateRes.body.status).should.match('WHY YOU GOTTA BE SO MEAN?');
  ...
  it('should be able to get a single Order if not signed in', function (done) {
    ...
    orderObj.save(function () {
      request(app).get('/api/orders/' + orderObj._id)
        .end(function (req, res) {
          // Set assertion
          res.body.should.be.instanceof(Object).and.have.property('status', order.status);
        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/orders')
            ...
            .end(function (orderSaveErr, orderSaveRes) {
              ...
              (orderSaveRes.body.status).should.equal(order.status);
                  ...
                  .end(function (err, res) {
                    ...
                    agent.get('/api/orders/' + orderSaveRes.body._id)
                      ...
                      .end(function (orderInfoErr, orderInfoRes) {
                        ...
                        (orderInfoRes.body.status).should.equal(order.status);
